    ...
    return (
        <div className='Keyboard-container'>
            ...
            <div id='KBrow_1' key='KBrow_1' className='Keyboard-row'>
                {firstRowLetters && firstRowLetters.map((letter) => <div id = {'char_' + letter.char} key={'char_' + letter.char} className={'Keyboard-char ' + usedChars[letter.char]}>{letter.char}</div>)}
            </div>
            <div id='KBrow_2' key='KBrow_2' className='Keyboard-row'>
                {secondRowLetters && secondRowLetters.map((letter) => <div id = {'char_' + letter.char} key={'char_' + letter.char} className={'Keyboard-char ' + usedChars[letter.char]}>{letter.char}</div>)}
            </div>
