...
const MineSweeper = () => {
    ...
    if(startGame){
        mainPage = <Board boardSize={boardSize} mineNum={mineNum} backToHome={backToHomeOnClick} />
    }
    else{
        mainPage = <HomePage startGameOnClick={startGameOnClick} mineNumOnChange={mineNumOnChange} boardSizeOnChange={boardSizeOnChange}/>
    }
